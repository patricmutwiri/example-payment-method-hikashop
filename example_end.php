...
<div class="hikashop_example_end" id="hikashop_example_end">
	<span id="hikashop_example_end_message" class="hikashop_example_end_message">
	...
	<form id="hikashop_example_form" name="hikashop_example_form" action="<?php echo $this->payment_params->payment_url;?>" method="post"> 
		...
		<?php
			...
			$doc->addScriptDeclaration("window.addEvent('domready', function() {document.getElementById('hikashop_example_form').submit();});");
